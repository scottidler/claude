---
name: e2e-v3
description: Run loopr v3/v4 E2E tests with active monitoring. Use ONLY for the legacy `~/repos/scottidler/loopr` (v3) or `~/repos/scottidler/loopr-v4` repos. For v5 (`~/repos/scottidler/loopr-v5`), use `/e2e` instead. Triggers: "e2e v3", "e2e v4", "test rust-version v3", "test python-api v3", or any explicit v3/v4 e2e request.
allowed-tools: Bash, Read, Grep, Glob, Agent
---

# Loopr E2E Test Runner with Active Monitoring (v3/v4)

> **Legacy.** This skill targets the v3/v4 paths and command surface. The v5
> equivalent is `/e2e` (different binary location, different log layout,
> different CLI verbs). Do not invoke this skill against v5.
