...
> **Note:** this file documents the older **gemini-cli** backend. Since the
> migration to **agy (Antigravity)**, new failure modes (recurring empty-return /
> no review content) are collected in `agy-failure-log.md` in this directory.
